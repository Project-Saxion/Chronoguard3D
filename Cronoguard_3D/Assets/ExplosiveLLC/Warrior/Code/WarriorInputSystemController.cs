...
namespace WarriorAnims
{
	...
	public class WarriorInputSystemController : MonoBehaviour
    {
        ...
        {
            try {
				inputAiming = warriorInputs.Warrior.Aiming.WasPressedThisFrame();
				inputAimHorizontal = warriorInputs.Warrior.Aiming.ReadValue<Vector2>().x;
				inputAimHorizontal = warriorInputs.Warrior.Aiming.ReadValue<Vector2>().y;
				inputAttack = warriorInputs.Warrior.Attack.WasPressedThisFrame();
				inputAttackMove = warriorInputs.Warrior.AttackMove.WasPressedThisFrame();
				inputAttackRanged = warriorInputs.Warrior.AttackRanged.WasPressedThisFrame();
				inputAttackSpecial = warriorInputs.Warrior.AttackSpecial.WasPressedThisFrame();
				inputBlock = warriorInputs.Warrior.Block.IsPressed();
				inputDeath = warriorInputs.Warrior.Death.WasPressedThisFrame();
				inputJump = warriorInputs.Warrior.Jump.WasPressedThisFrame();
				inputLightHit = warriorInputs.Warrior.LightHit.WasPressedThisFrame();
				inputRoll = warriorInputs.Warrior.Roll.WasPressedThisFrame();
				inputTarget = warriorInputs.Warrior.Target.IsPressed();
